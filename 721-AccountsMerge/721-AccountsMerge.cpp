// Last updated: 12/8/2025, 11:27:49 PM
// class Solution {
// private:
//     unordered_map<string, vector<int>> map;
//     vector<vector<string>> result;
//     void merge(const vector<vector<string>>& accounts, vector<bool>& visited, const string email, set<string>& emails) {
//         for (int line : map[email]) {
//             if (!visited[line]) {
//                 visited[line] = true;
//                 for (int i = 1; i < accounts[line].size(); ++i) {
//                     string next_email = accounts[line][i];
//                     emails.insert(next_email);
//                     merge(accounts, visited, next_email, emails);
//                 }
//             }
//         }
//     }
...
//                 set<string> emails;
//                 merge(accounts, visited, accounts[i][1], emails);
//                 account.insert(account.end(), related_emails.begin(), related_emails.end());
